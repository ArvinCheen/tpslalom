...
class schedule extends Command
{
    ...
    public function handle()
    {
        ...
        $this->printTime('決賽', '初級指定套路', '國小低年級', '男', '300', '2');
        $this->printTime('決賽', '初級指定套路', '國小低年級', '女', '300', '2');
        $this->printTime('決賽', '初級指定套路', '國小中年級', '男', '300', '2');
        $this->printTime('決賽', '初級指定套路', '國小中年級', '女', '300', '2');
        $this->printTime('決賽', '初級指定套路', '國小高年級', '男', '300', '2');
        $this->printTime('決賽', '初級指定套路', '國小高年級', '女', '300', '2');
        $this->printTime('決賽', '初級指定套路', '國中', '男', '300', '2');
        $this->printTime('決賽', '初級指定套路', '國中', '女', '300', '2');
        $this->printTime('決賽', '初級指定套路', '高中', '男', '300', '2');
        $this->printTime('決賽', '初級指定套路', '高中', '女', '300', '2');
        $this->printTime('決賽', '初級指定套路', '大專', '男', '300', '2');
        $this->printTime('決賽', '初級指定套路', '大專', '女', '300', '2');
        $this->printTime('決賽', '初級指定套路', '社會', '男', '300', '2');
        $this->printTime('決賽', '初級指定套路', '社會', '女', '300', '2');
        $this->printTime('決賽', '中級指定套路', '國小低年級', '男', '360', '1');
        $this->printTime('決賽', '中級指定套路', '國小低年級', '女', '360', '1');
        $this->printTime('決賽', '中級指定套路', '國小中年級', '男', '360', '1');
        $this->printTime('決賽', '中級指定套路', '國小中年級', '女', '360', '1');
        $this->printTime('決賽', '中級指定套路', '國小高年級', '男', '360', '1');
        $this->printTime('決賽', '中級指定套路', '國小高年級', '女', '360', '1');
        $this->printTime('決賽', '中級指定套路', '國中', '男', '360', '1');
        $this->printTime('決賽', '中級指定套路', '國中', '女', '360', '1');
        $this->printTime('決賽', '中級指定套路', '高中', '男', '360', '1');
        $this->printTime('決賽', '中級指定套路', '高中', '女', '360', '1');
        $this->printTime('決賽', '中級指定套路', '大專', '男', '360', '1');
        $this->printTime('決賽', '中級指定套路', '大專', '女', '360', '1');
        $this->printTime('決賽', '中級指定套路', '社會', '男', '360', '1');
        $this->printTime('決賽', '中級指定套路', '社會', '女', '360', '1');
