...
class GroupingController extends Controller
{
    ...
    {
        $this->setGrouping('初級組','幼童組','男','前進雙足S形','','','1','60');
        $this->setGrouping('初級組','幼童組','女','前進雙足S形','','','1','60');
        ...
        $this->setGrouping('選手組','幼童組','男','前進雙足S形','','','2','60');
        $this->setGrouping('選手組','幼童組','女','前進雙足S形','','','2','60');
        ...
        $this->setGrouping('選手組','幼童組','男','前進交叉形','','','2','60');
        $this->setGrouping('選手組','幼童組','女','前進交叉形','','','2','60');
        ...
        $this->setGrouping('選手組','幼童組','男','前進單足S形','','','2','60');
        $this->setGrouping('選手組','幼童組','女','前進單足S形','','','2','60');
