...
class GroupingController extends Controller
{
    public function grouping()
    {
        ...
        $this->setGrouping('選手組', '國小一年級組', '男', '前進雙足S型');
        $this->setGrouping('選手組', '國小一年級組', '女', '前進雙足S型');
        $this->setGrouping('選手組', '國小二年級組', '男', '前進雙足S型');
        $this->setGrouping('選手組', '國小二年級組', '女', '前進雙足S型');
        $this->setGrouping('選手組', '國小三年級組', '男', '前進雙足S型');
        $this->setGrouping('選手組', '國小三年級組', '女', '前進雙足S型');
        $this->setGrouping('選手組', '國小四年級組', '男', '前進雙足S型');
        $this->setGrouping('選手組', '國小四年級組', '女', '前進雙足S型');
        $this->setGrouping('選手組', '國小五年級組', '男', '前進雙足S型');
        $this->setGrouping('選手組', '國小五年級組', '女', '前進雙足S型');
        $this->setGrouping('選手組', '國小六年級組', '男', '前進雙足S型');
        $this->setGrouping('選手組', '國小六年級組', '女', '前進雙足S型');
        ...
        $this->setGrouping('初級組', '國小一年級組', '男', '前進雙足S型');
        $this->setGrouping('初級組', '國小一年級組', '女', '前進雙足S型');
        $this->setGrouping('初級組', '國小二年級組', '男', '前進雙足S型');
        $this->setGrouping('初級組', '國小二年級組', '女', '前進雙足S型');
        $this->setGrouping('初級組', '國小三年級組', '男', '前進雙足S型');
        $this->setGrouping('初級組', '國小三年級組', '女', '前進雙足S型');
        $this->setGrouping('初級組', '國小四年級組', '男', '前進雙足S型');
        $this->setGrouping('初級組', '國小四年級組', '女', '前進雙足S型');
        $this->setGrouping('初級組', '國小五年級組', '男', '前進雙足S型');
        $this->setGrouping('初級組', '國小五年級組', '女', '前進雙足S型');
        $this->setGrouping('初級組', '國小六年級組', '男', '前進雙足S型');
        $this->setGrouping('初級組', '國小六年級組', '女', '前進雙足S型');
        $this->setGrouping('選手組', '幼童組', '男', '前進單足S型');
        $this->setGrouping('選手組', '幼童組', '女', '前進單足S型');
        $this->setGrouping('選手組', '國小一年級組', '男', '前進單足S型');
        $this->setGrouping('選手組', '國小一年級組', '女', '前進單足S型');
        $this->setGrouping('選手組', '國小二年級組', '男', '前進單足S型');
        $this->setGrouping('選手組', '國小二年級組', '女', '前進單足S型');
        $this->setGrouping('選手組', '國小三年級組', '男', '前進單足S型');
        $this->setGrouping('選手組', '國小三年級組', '女', '前進單足S型');
        $this->setGrouping('選手組', '國小四年級組', '男', '前進單足S型');
        $this->setGrouping('選手組', '國小四年級組', '女', '前進單足S型');
        $this->setGrouping('選手組', '國小五年級組', '男', '前進單足S型');
        $this->setGrouping('選手組', '國小五年級組', '女', '前進單足S型');
        $this->setGrouping('選手組', '國小六年級組', '男', '前進單足S型');
        $this->setGrouping('選手組', '國小六年級組', '女', '前進單足S型');
