...
//
//                    $resultsWithOtherCity = EnrollModel::select('player_number', 'name', 'final_result', 'rank')
//                        ->leftJoin('player', 'player.id', 'enroll.player_id')
//                        ->where('game_id', config('app.game_id'))
//                        ->where('group', $schedule->group)
//                        ->where('level', $schedule->level)
...
//
//                    $docs[] = (object)[
//                        'title' => "$schedule->order - $schedule->level  $schedule->group  $schedule->gender 子組  $schedule->item",
//                        'resultsWithTaipei' => $resultsWithTaipei,
//                        'resultsWithOtherCity' => $resultsWithOtherCity
//                    ];
                }
//                    $sheet->cell('A1', function ($cell) use ($schedule) {
//                        $abridgeName = GameModel::where('id', config('app.game_id'))->value('abridge_name');
