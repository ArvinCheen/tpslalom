    ...
    <div class="mh mb-5">
        <div class="container">
            ...
            <form action='{{ URL('enroll/enroll') }}' method="post">
                ...
                <input type="hidden" name="action" value="修改報名資訊"/>
                <div class="row">
                    ...
                    @else
                        <button class="btn btn-lg btn-block" type="button" disabled>勘誤時間已結束</button>
                    @endif
...
@section('js')
    <script>
        ...
        function getPlayer(playerId) {
            $.ajax({
                url: "{{ URL('player/ajaxGetPlayer') }}/" + playerId,
                dateType: "JSON",
